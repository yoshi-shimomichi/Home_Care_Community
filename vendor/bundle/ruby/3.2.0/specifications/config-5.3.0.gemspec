...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubyconfig/config/issues", "changelog_uri" => "https://github.com/rubyconfig/config/blob/master/CHANGELOG.md", "source_code_uri" => "https://github.com/rubyconfig/config" } if s.respond_to? :metadata=
